export class MarkdownReporter {
    ...
    generate(results, score, featureUsage, fixImpact) {
        const sections = [];
        // Header
    ...
    generateFixImpactSection(impact) {
        const lines = [];
    ...
    generateFeatureUsageSection(featureUsage) {
        const lines = [];
    ...
    generateRecommendationsSection(results, score) {
        const lines = [];
