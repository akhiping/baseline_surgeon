 ...
 */
export function calculateBaselineScore(results: AnalysisResult[]): BaselineScore {
 ...
 */
export function analyzeFeatureUsage(results: AnalysisResult[]): FeatureUsage[] {
...
export function calculateFixImpact(
